...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
            ...
            WebElement parentBox = driver.findElement(By.xpath("//div[contains(@class,'shipping-container MuiBox-root css-vooagt')]//div[@class='MuiBox-root css-0']"));
            ...
            for (WebElement box : allBoxes) {
                ...
                //if (box.findElement(By.xpath("//div[contains(@class ,'address-item not-selected')]/div/p")).getText().replaceAll(" ", "")
    ...
    public Boolean placeOrder() {
        try {
            ...
            //List<WebElement> elements = driver.findElementsByXPath("//*[text()='PLACE ORDER']");
            List<WebElement> elements = driver.findElements(By.xpath("//button[contains(@class,'css-177pwqq')]"));
