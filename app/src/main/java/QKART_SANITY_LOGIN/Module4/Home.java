...
public class Home {
            ...
            //Thread.sleep(3000);
             ...
             wait.until(
                ExpectedConditions.or(
                  ...
                  ExpectedConditions.elementToBeClickable(By.xpath("//p[contains(text(),'"+product+"')]")),
   ...
   /*  public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
           ...
           // WebElement cartParent = driver.findElement(By.className("MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-3 css-1q5pok1"));
            //List<WebElement> cartContents = cartParent.findElements(By.xpath("//*[@class ='MuiBox-root css-0']/div/div/div[1]"));
            WebElement cartParent = driver.findElement(By.xpath("//div[contains(@class,'cart MuiBox-root css-0')]"));
            List<WebElement> cartContents = cartParent.findElements(By.xpath("//div[contains(@class,'MuiBox-root css-1gjj37g')]"));
            ...
            for (WebElement cartItem : cartContents) {
               // actualCartContents.add(cartItem.findElement(By.className("css-1gjj37g")).getText().split("\n")[0]);
                //actualCartContents.add(cartItem.findElement(By.xpath("//*[@class ='MuiBox-root css-0']/div/div/div[1]")).getText().split("\n")[0]);
                actualCartContents.add(cartItem.findElement(By.xpath("//div[1]")).getText().split("\n")[0]);
...
public Boolean verifyCartContents(List<String> expectedCartContents) {
    try {
        ...
        WebElement cartParent = driver.findElement(By.xpath("//div[contains(@class,'cart MuiBox-root css-0')]"));
        List<WebElement> cartContents = cartParent.findElements(By.xpath("./div"));
